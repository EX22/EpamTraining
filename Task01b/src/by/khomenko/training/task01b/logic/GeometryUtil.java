...
public class GeometryUtil {
     ...
     */
    public static double pointToPlaneDistance(final Vector point,
                                              final Plane plane) {
     ...
     * @return boolean value, true if cutting plane is parallel cone's base,
     * otherwise false.
     */
    public static boolean isParallel(final Cone cone, final Plane plane) {
     ...
     */
    public static double vectorLength(final Vector vector) {
