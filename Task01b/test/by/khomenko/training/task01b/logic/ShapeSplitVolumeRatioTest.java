...
public class ShapeSplitVolumeRatioTest {
    ...
    private Cone cone = new Cone(vectorCone,9.0, 3.0, directionCone, "TestBasePositionName" );
    private ShapeSplitVolumeRatio shapeSplitVolumeRatio = new ShapeSplitVolumeRatio();
    ...
    public void testCalcConeSplitVolumeRation() throws ShapeException {
        double actual = shapeSplitVolumeRatio.calcConeSplitVolumeRation(cone, cuttingPlane);
