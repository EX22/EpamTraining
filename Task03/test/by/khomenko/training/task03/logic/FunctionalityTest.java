...
public class FunctionalityTest {
    ...
    public void testSortParagraphBySentencesAmount() {
        ...
        List<TextComponent> list = paragraphParser.parseIt(text);
        int previousParagraphSize = list.get(0).getComponentsCount();
        int nextParagraphSize = list.get(1).getComponentsCount();
        assertTrue(previousParagraphSize <= nextParagraphSize);

    }

    @Test
    public void testSortWordsByLength() {
        //TODO Is it necessary to mention somewhere in the docs that this sort
    ...
    public void testRestoreText() {
        ...
        //TODO What kind of assertion should be done here? Known that restored
        // text has calculated bin exp, means that we can't assert it with
        // initial text.
    }
}